...
assert.deepEqual(deployed,local,'The deployed package is not the tested local revision');
const report={target,release:local.release,testedAt:new Date().toISOString(),files:[],passed:false};
